...
<?php
		...
		$role = $_SESSION['role'];
		if($role =='Student'){
			$sql = "SELECT * from user_target where user_id ={$email} ;";
			$query = $dbh -> prepare($sql);
			$query->execute();
...
?>
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-12">
								...
								if($role =='Student'){
									?>
								<a href="target_add.php">new target</a>
							<?php }?>
	...
	<tr>
		...
		<?php 
				...
				if($role =='Student'){
									?>
		<td><a href="target_edit.php?id=<?php echo $v->id?>">edit</a> |<a href="dotargetdelete.php?id=<?php echo $v->id?>">delete</a></td>
							<?php }?>
