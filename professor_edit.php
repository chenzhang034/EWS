						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">professor_edit</div>
<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>

									<div class="panel-body">
<form method="post" class="form-horizontal" enctype="multipart/form-data" action="dostudentedit">
...
<div class="form-group">
	...
	<div class="col-sm-4">
	<input type="text" name="id" class="form-control" required value="<?php echo htmlentities($result->user_id);?>" readonly>
	</div>
