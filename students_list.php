...
<?php
		...
		$sql = "SELECT * from user where authority = 'Student';";
		$query = $dbh -> prepare($sql);
...
?>
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-12">
								...
								if($role !='Student'){
									?>
								<a href="students_add.php">new student</a>
							<?php }?>
	...
	<tr>
		...
		<?php 
				...
				if($role !='Student'){
									?>
		<td><a href="students_edit.php?id=<?php echo $v->user_id?>">edit</a> |<a href="dostudentdelete.php?id=<?php echo $v->user_id?>">delete</a></td>
							<?php }?>
